...
modules_path = '../../CryoGrid/source';
addpath(genpath(modules_path));

start_year = 1981;
end_year = 2100;
result_path = '../results/';
run_number = 'ERC_2021_ground_ice1';
...
for year = start_year:end_year
    ...
    load([result_path run_number '/' run_number '_' num2str(year) out_timstamp '.mat'])
    
    %define the grid to which variables are interpolated
    target_cell_size = 0.02;
    new_grid = 20 + [-10:target_cell_size:0]';
